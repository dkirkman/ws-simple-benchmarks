...
let module_options = function(options) {
  ...
  return new Promise(function(resolve, reject) {
    let wasm_name = new Promise(function(resolve, reject) {
      if (nodep) resolve('libdkbench.wasm');
      else resolve(import(/* webpackChunkName: "wasmName" */ "./libdkbench.wasm"));
    });
...
export default function (options, cb) {
  if (typeof options === 'object'
      && options['asm.js'] === true) {
    console.log('loading asm.js version of libdkbench');
    ...
    // loading webpack
    console.log('loading WebAssembly version of libdkbench');

    module_options(options).then(mopts => {
      import(/* webpackChunkName: "libdkbench" */ 
